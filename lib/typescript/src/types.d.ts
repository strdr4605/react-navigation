...
export declare type ScreenNavigationProps<ParamList extends ParamListBase = ParamListBase, RouteName extends keyof ParamList = string> = {
    route: RouteProp<ParamList, RouteName>;
    navigation: any;
};
export declare type ScreenOptionsCallback<ScreenOptions extends object = object> = (props: ScreenNavigationProps) => ScreenOptions;
